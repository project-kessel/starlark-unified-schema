...
add_v1_based_permission("ros", "analysis", "read", "ros_read_analysis_assigned")
...
add_contingent_permission("inventory_host_view", "ros_read_analysis_assigned", "ros_read_analysis")
# Passes through the ros_read_analysis permission from a host's workspace to the host itself
expose_host_permission("ros_read_analysis", "ros_read_analysis")
